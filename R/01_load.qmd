...
The raw data consists of two subsets of data that contain the gene expressions and phenoctypes of subjects. These are loaded into each their *dat_load.tsv* file. We use `Biobase` to extract the data of interest, as our data is formated as an 'ExpressionSet' (<https://www.bioconductor.org/packages//2.10/bioc/html/Biobase.html>).
