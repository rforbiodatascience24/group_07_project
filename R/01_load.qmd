...
Load `GEOquery` library, which is used to retrieve datasets from NCBI's Gene Expression Omnibus(<https://www.bioconductor.org/packages//2.10/bioc/html/GEOquery.html>). Also load `Biobase`, explained further down.
...
Fetch data set *GSE11512* and extract first argument arcording to GEO datset structure.
