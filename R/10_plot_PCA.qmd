...
For the principal component analysis (PCA), the expression data is visualized projected onto the PCs, along the proportion of variance explained (PVE) for each component.
