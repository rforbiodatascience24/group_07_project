...
First, we recreate the plots from the report to visualize the percentages, however, since we only have data for a single tissue, we just replicate the \_\_\_\_. We also add the human vs macaque classification data.
