...
aug_mlc_stats <- mlc_data |>
  ...
  map_dfr(~ {
    ...
    t_stat_pvalues_chimp <- t_stat_pvalues_chimp |>
      mutate(age_significant_chimp = if_else(t_stat_pvalue_chimp_age < 0.05, "yes", "no"),
             species_significant_chimp = if_else(t_stat_pvalue_chimp_human_chimp_species < 0.05, "yes", "no"))
    
    t_stat_pvalues_maca <- t_stat_pvalues_maca |>
      mutate(age_significant_maca = if_else(t_stat_pvalue_maca_age < 0.05, "yes", "no"),
             species_significant_maca = if_else(t_stat_pvalue_maca_human_maca_species < 0.05, "yes", "no"))
