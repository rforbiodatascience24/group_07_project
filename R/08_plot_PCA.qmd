...
combined_plot <- plot_pc_pve +
  ...
  geom_richtext(
    aes(x = -0.01,
        y = 1.05),
    label = paste(
      "The main PVE is by the attributes <span style='color:", age_color, ";'>age</span> and ",
      "<span style='color:", species_color, ";'>species</span>..."),
    hjust = 0,
    size = 4,
    label.color = NA,
    fill = NA) +
  geom_richtext(
    aes(x = 1.01,
        y = -0.05),
    label = paste(
      "...whereas <span style='color:", sex_color, ";'>sex</span> is mainly represented in the lower ranking principal components."),
    hjust = 1,
    size = 4,
    label.color = NA,
    fill = NA)
